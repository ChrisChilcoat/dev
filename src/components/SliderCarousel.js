    ...
    return (
      <>
        <button 
          ...
          <span class="bg-white border  -left-[20px] absolute shadow-lg inline-flex items-center justify-center w-10 h-10 rounded-full group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
        ...
        <span class="bg-white border  -right-[20px] absolute shadow-lg inline-flex items-center justify-center w-10 h-10 rounded-full group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
